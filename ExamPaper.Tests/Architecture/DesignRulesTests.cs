...
public class DesignRulesTests
{
    ...
    public void CoreModels_Should_BeSealed()
    {
        ...
        Assert.True(result.IsSuccessful, "Модели в слое Core (папка Models) должны быть помечены как sealed.");
    }
    ...
    public void InfrastructureImplementations_Should_BeSealed()
    {
        ...
        Assert.True(result.IsSuccessful, "Реализации в слое Infrastructure должны быть помечены как sealed.");
    }
